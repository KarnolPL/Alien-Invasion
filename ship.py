...
class Ship(Sprite):
    ...
    def __init__(self, ai_game):
        """Inicjalizacja statku kosmicznego i jego połozenia początkowego."""
        super().__init__()
        ...
        #Połozenie poziome statku  jest przecgowtwane w postaci liczby
        #zmiennoprzecinkowej
        self.x = float(self.rect.x)
        
        #Opcja wzkazująca na poruszanie sie statku.
    ...
    def update(self):
        ...
        na jego ruch.
        """
        #Uaktualnienie wartosci współrzędnej X statku a nie jego prostokąta.
    ...
    def center_ship(self):
        """Umieszenie statku na srodku i na dole planszy"""
        self.rect.midbottom = self.screen_rect.midbottom
        self.x = float(self.rect.x)
