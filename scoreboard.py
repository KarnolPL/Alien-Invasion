...
class Scoreboard:
    """Klasa przeznaczona do punktacji"""

    def __init__(self, ai_game):
        """Inicjalizacja atrybutów do punktacji"""
    ...
    def prep_ships(self):
        """Wyświetla liczbe statków ktore zostały graczowi."""
        self.ships = Group()
    ...
    def show_score(self):
        """Wyswietlanie punktacji oraz statków"""
